...
<div class="jiko-cta_wrap">
	<div class="row align-middle">
		<div class="column small-12 medium-3 large-2 text-center"><img src="<?php echo '//www.law-yamashita.com/wp-content/themes/law-yamashita/assets/img/lp/jiko/soudan-free.png'; ?>" alt="広島最大級の山下江法律事務所なら交通事故の相談が無料！"></div>
	...
	<div class="row align-middle">
		...
		<div class="column small-12 large-6">
			<div class="jiko-up_wrap">
				...
				<p class="jiko-up_desc">自賠責保険とは、全員が加入しなければならない保険で、人身事故のみに適用されます。被害者の最低補償を行う保険ですので、②任意保険や③裁判基準と比較すると<span class="bg-line">一般的に高くなることが多い</span>です。</p>
			</div>
			<div class="jiko-up_wrap">
				<h3 class="jiko-up_title">②任意保険</h3>
				<p class="jiko-up_desc">任意で加入する保険です。自賠責保険でカバーできない損害を補填することが目的であるため、自賠責保険で計算した賠償金額（慰謝料・給与損害・遺失利益など）より高くはなりますが、<span class="bg-line">裁判所の基準よりも低くなることが多い</span>です。。</p>
			</div>
			<div class="jiko-up_wrap">
				<h3 class="jiko-up_title">③裁判基準</h3>
				<p class="jiko-up_desc">過去の交通事故に関する裁判の判例などを踏まえて、損害の内容ごとに基準が示されています。弁護士が介入すると示談交渉からこの基準で計算します。<br>弁護士報酬を差し引いても、お手元に残る賠償金が増える場合が多いですので、<span class="bg-line">「弁護士費用のお支払い」を考慮しても、弁護士に任せるほうがメリットが多い</span>です。</p>
			</div>
		</div>
...
<section id="section-2" data-magellan-target="section-2">
	<div class="row">
		...
		<div class="column small-12">
			<div class="cases">
				<h4>後遺障害の事故</h4>
				<div class="img-wrapper"><img src="<?php echo '//www.law-yamashita.com/wp-content/themes/law-yamashita/assets/img/traffic-acc-cases_02.png'; ?>" alt="1010万円の増額"></div>
			...
			<div class="cases">
				<h4>後遺障害の事故</h4>
				<div class="img-wrapper"><img src="<?php echo '//www.law-yamashita.com/wp-content/themes/law-yamashita/assets/img/traffic-acc-cases_04.png'; ?>" alt="300万円の増額"></div>
			...
			<div class="cases">
				<h4>死亡事故</h4>
				<div class="img-wrapper"><img src="<?php echo '//www.law-yamashita.com/wp-content/themes/law-yamashita/assets/img/traffic-acc-cases_01.png'; ?>" alt="330万円の増額"></div>
			...
			<div class="cases">
				<h4>バイク対自動車</span></h4>
				<div class="img-wrapper"><img src="<?php echo '//www.law-yamashita.com/wp-content/themes/law-yamashita/assets/img/traffic-acc-cases_03.png'; ?>" alt="330万円の増額"></div>
...
<section class="jiko-cta_wrap">
	<div class="row align-middle">
		<div class="column small-12 medium-9 large-10">
			<h2 class="jiko-cta_title">交通事故に遭われたら<br><strong class="color-red font-2x">お早め</strong>に弁護士に相談しましょう。</h2>
			<p class="jiko-cta_desc">症状が固定されていない早期からご相談いただくと、弁護士が代わりに交渉などを行うことで治療に専念できるメリットがあります。<br>さらに、適切な後遺障害を認定してもらえるよう通院についてのアドバイス、必要な場合は医師宛の書面を作成したり、直接医師と面談し、診断書の内容についての理解を求めることができます。</p>
		</div>
		<div class="column small-12 medium-3 large-2 text-center"><img src="<?php echo '//www.law-yamashita.com/wp-content/themes/law-yamashita/assets/img/lp/jiko/soudan-free.png'; ?>" alt="交通事故に遭われたらお早めに弁護士へ無料の相談しましょう。"></div>
...
<section id="section-3" class="jiko-section" data-magellan-target="section-3">
	<div class="row">
		<div class="column small-12">
			...
			<p class="text-center"><img src="<?php echo '//www.law-yamashita.com/wp-content/themes/law-yamashita/assets/img/lp/jiko/timing-flow.png'; ?>" alt="弁護士に依頼する最適なタイミングは治療前！"></p>
			<h3 class="jiko-section_title -sub">交通事故に強い山下江法律事務所のサポート</h3>
			<div class="jiko-support_wrap bg-grafpaper">
			<div class="jiko-support">
				<h4 class="jiko-support_title">初期の費用という負担をなくしました</h4>
			...
			<div class="jiko-support">
				...
				<p class="jiko-support_desc">ケガなどで通院が必要な方には、適切な後遺障害が認定されるようアドバイスします。</p>
			</div>
			<div class="jiko-support">
				<h4 class="jiko-support_title">保険会社との交渉</h4>
				<p class="jiko-support_desc">弁護士が適切な賠償金（慰謝料・給与損害・遺失利益など）によるきちんとした補償を受けられるよう、保険会社との交渉をすべて行いますので、弁護士に任せて治療に専念できます。</p>
			</div>
			<div class="jiko-support">
				<h4 class="jiko-support_title">後遺障害認定のサポート</h4>
				<p class="jiko-support_desc">適切な等級で後遺障害を認定してもらうためにはどのような書類を用意すべきか、適切な記述があるか。これらを判断するのには一定以上の知識・経験が必要です。<br><span class="bg-line">準備が不十分であったために等級を獲得できなかったといった事態を避けるため</span>、等級認定手続を経る前に、弁護士に一度相談されることをお勧めいたします。</p>
			</div>
			<div class="jiko-support">
				<h4 class="jiko-support_title">必要に応じて医師と直接面談</h4>
				<p class="jiko-support_desc">医師宛の書面を作成したり、必要に応じて直接医師と面談したりします。<br>このようにして、適切な等級での後遺障害を認定されるようサポートします。</p>
			</div>
			<div class="jiko-support">
				<h4 class="jiko-support_title">症状固定という重要な判断を見極めます</h4>
				<p class="jiko-support_desc">治療を続けても大幅な改善が見込めなくなった段階のことを「症状固定」といいます。<br>この症状固定は、事故による損害賠償の額に大きく影響するため、非常に大きな意味を持ちます。<br>最悪の場合、治療継続が必要なのに、治療費を打ち切られて、訴訟になっても裁判所が認めてくれないこともあります。<br>とても重要な判断ですから、<span class="bg-line">専門家である弁護士が判断を後押し</span>をします。</p>
			</div>
			<div class="jiko-support">
				<h4 class="jiko-support_title">すでに後遺障害認定結果が出てしまった方でも見直し可能！</h4>
				<p class="jiko-support_desc">後遺障害認定結果が出てしまった方でも、それが適切ではない場合、認定結果の見直しを求められます。<br>実際に、弁護士介入後、病院（医師）のもとへ同行したことで、<span class="bg-line">後遺障害が認められなかったケースでも</span>、後遺障害の認定を受けました。</p>
			</div>
			<div class="jiko-support">
				<h4 class="jiko-support_title">適切な賠償金（慰謝料・給与損害・遺失利益など）の増額には「交渉」が不可欠</h4>
				<p class="jiko-support_desc">増額するためには、保険会社との粘り強い交渉が不可欠です。依頼者に代わってその「交渉」をできるのは、弁護士のみです。<br><a href="#section-1">慰謝料などの増額</a>にあるように、弁護士は一般的に高額である③裁判基準をもとに適切な賠償金まで増額して示談交渉します。<br>弁護士が介入することにより、多くの場合は賠償金が増額しますので、<u>弁護士報酬を考慮しても、弁護士不介入の場合に比べて、多くの賠償金を得ることができます</u>。</p>
			</div>
		</div>
	</div>
</section>
...
<section id="section-4" class="jiko-section" data-magellan-target="section-4">
	<div class="row">
		...
		<div class="column small-12 article-body">
			...
			<p>平成23年以降の交通事故案件での実績は、<strong class="bg-line">相談数1,948件、受任件数817件</strong>（平成28年度末現在）です。地元広島における法律事務所で、これだけ多数の相談件数、受任件数の実績があります。</p>
			<h3>2. 後遺障害など医学的知識があります</h3>
			...
			<p>後遺障害の認定や事故の相手方保険会社との交渉には、高い専門性と経験が求められます。当事務所における多数の解決事例データを集積・分析し、事務所全体で共有化することで被害者に最も有利な解決を実現するため、交通事故チームを結成しています。</p>
			<h3>4. 事故直後から治療・解決までご相談ください</h3>
			<p>交通事故に遭われた場合、早い段階で弁護士にご相談いただければ、通院についてのアドバイスや適切な等級の後遺障害認定にあたってのアドバイスを行い、必要に応じて病院（医師）まで同行します。すでに認定されてしまった後遺障害を覆すのは難しい場合があるので、<span class="bg-line">なるべく早い段階でご相談</span>ください。<br>あなたは一人ではありません。私たち弁護士が治療から解決まで寄り添います。</p>
			<h3>5. 相談料や着手金など初期費用面で負担がありません</h3>
			<p class="jiko-images"><img src="//www.law-yamashita.com/wp-content/themes/law-yamashita/assets/img/rates/jiko-sodan.png" alt="被害者救済のため、被害者の相談料は無料です。"><img src="//www.law-yamashita.com/wp-content/themes/law-yamashita/assets/img/rates/jiko-retainer.png" alt="被害者救済のため、被害者の相談料は無料です。"></p>
			<p>被害者救済のため、交通事故に遭われた方の<strong class="bg-line">相談料・着手金は無料</strong>です。（弁護士費用特約により保険会社から支払われる場合は別）</p>
		</div>
	</div>
</section>
...
<section id="section-6" class="jiko-section" data-magellan-target="section-6">
	<div class="row">
		<div class="column small-12">
			<h2 class="jiko-cta_title text-center">「弁護士費用特約」が付いていれば<br><span class="font-2x color-red">弁護士費用</span>が<span class="font-2x color-red">無料</span>に!</h2>
			<p class="jiko_cta_desc p2">弁護士に依頼すると、費用が高いイメージから相談しづらいという被害者の方もいらっしゃると思います。しかし、保険の特約に「弁護士費用特約」が付いていれば、その中でまかなわれる場合が多いです。</p>
			<p class="p1 bg-gainsboro">特殊なケースを除けば保険会社が支払うので、基本的に<span class="bg-line">お客様自身のご負担はありません。</span>実費や出張日当などの費用についても弁護士費用特約から支出されます。<br>多くの保険会社では、弁護士費用の総額が300万円までと上限が定めてありますが、弁護士費用が300万円以上になるようなケースはまれですので、<span class="bg-line">多くの場合は弁護士費用特約でカバーできます。</span><br>※弁護士費用特約は保険会社の約款により細かい条件などがあるケースがございます。まずは無料でご相談ください。</p>
		</div>
	</div>
</section>
...
<div class="jiko-cta_wrap">
	<div class="row align-middle">
		...
		<div class="column small-12 small-3 large-2 text-center"><img src="<?php echo '//www.law-yamashita.com/wp-content/themes/law-yamashita/assets/img/lp/jiko/soudan-free.png'; ?>" alt="広島最大級の山下江法律事務所なら交通事故の相談が無料！"></div>
...
<ul class="no-bullet m0 link-external-block text-center">
	...
	<li><a class="link-external img" href="https://hiroshima-jiko.com/" target="_blank" title="山下江法律事務所の交通事故サイト"><img src="<?php echo DTDSH_HOME_URL; ?>/wp-content/uploads/2015/05/external-links-1.png" alt="賠償金額が増額するケースが大半！交通事故の専門サイト"></a></li>
</ul>
