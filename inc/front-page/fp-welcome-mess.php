<section class="fp-wel column-3">
	<div class="column-2-3">
		...
		<div class="body-block">
			...
			<p> </p>
			<p>当事務所は，平成7年7月11日創立以来「親切な相談」「適切な解決」をモットーに業務に励んできました。
			<p> </p>
			...
			<p><a href="<?php echo get_the_permalink( '548' ); ?>" class="button" title="山下江について">山下江について<i class="fa fa-angle-right ml1"></i></a></p>
		</div>
	</div>
